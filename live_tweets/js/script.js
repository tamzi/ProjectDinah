...
setInterval( function () {
  twitterFetcher.fetch('632785703882129408', 'feed', 1000, true, true, true, '', false, handleTweets, false);
}, 2500);
...
function handleTweets(tweets){
    ...
    while(n < x) {
      html += '<li class="hidden">' + tweets[n] + '</li>';
  ...
  $($(".hidden").get().reverse()).each( function(i){

		$(this).delay(2000*i).show("slow");
    setTimeout( function () {
